...
namespace MyCMS_WebApplication.Areas.Admin.Controllers
{
    public class PagesController : Controller
    {
        ...
        public PagesController()
        {
            ...
            _pageGroupRepository = new PageGroupRepository(_cmsContext);
        }
        ...
        public ActionResult Create([Bind(Include = "PageId,GroupId,PageTitle,ShortDescription,Description,Visit,ImageName,ShowInSlider,CreateDate")] Page page,HttpPostedFileBase imgUp)
        {
            ...
            ViewBag.GroupId = new SelectList(_pageGroupRepository.GetAllPageGroup(), "GroupId", "GroupTitle", page.GroupId);
            return View(page);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PageId,GroupId,PageTitle,ShortDescription,Description,Visit,ImageName,ShowInSlider,CreateDate")] Page page,HttpPostedFileBase imgUp)
        {
            if (ModelState.IsValid)
            {
                if (imgUp != null)
